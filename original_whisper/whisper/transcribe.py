...
from original_whisper.whisper.audio import (
    FRAMES_PER_SECOND,
    HOP_LENGTH,
    N_FRAMES,
    N_SAMPLES,
...
from original_whisper.whisper.decoding import DecodingOptions, DecodingResult
from original_whisper.whisper.timing import add_word_timestamps
from original_whisper.whisper.tokenizer import LANGUAGES, TO_LANGUAGE_CODE, get_tokenizer
from original_whisper.whisper.utils import (
    exact_div,
    format_timestamp,
    get_end,
    get_writer,
...
if TYPE_CHECKING:
    from original_whisper.whisper.model import Whisper
...
def cli():
    from original_whisper.whisper import available_models
    ...
    from original_whisper.whisper import load_model
